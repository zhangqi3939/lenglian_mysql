...
Nav.prototype.init = function(){
  str = '<div class="navList"><img src="../img/index.png" alt="" /><span>监控</span><div><a href="cold.html">冷藏箱</a><a href="warm.html">保温箱</a></div></div>';  
  ...
  str += '<div class="navList"><img src="../img/xingc.png" alt="" /><span>行程</span><div><a href="route_list.html">行程列表</a></div></div>';
  ...
  // str += '<a href="assistance.html"><img src="../img/bangz.png" alt="" />  <span>帮助</span></a>';
  $(this.id).html(str);
  if(this.index == 9){
    $(this.id).find('a').eq(this.index).addClass('current').attr('href','javascript:void(0)');
  }else{
    $(this.id).find('a').eq(this.index).addClass('current').attr('href','javascript:void(0)');
    $(this.id).find('a').eq(this.index).parents('div.navList').addClass('current');
  }
...
ManageNav.prototype.init = function(){
  ...
  str += '<a href="user.html" class="current"><i class="fa fa-user-o fa-fw"></i>用户</a>';
  ...
  $(this.id).html(str);
  $(this.id).find('a').eq(this.index).addClass('current').siblings().removeClass('current');
  if(this.index>1){
    $(this.id).find('a').eq(this.index).addClass('current').siblings().removeClass('current');
    $(this.id).find('div.navList').addClass('current').siblings().removeClass('current');
  }else{
    $(this.id).find('a').eq(this.index).addClass('current').siblings().removeClass('current');
  }
}
